...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # --- TF-IDF Scoring (limited features to reduce memory/time) ---
            ...
            # --- Export to Excel (write to disk to reduce memory) ---
            excel_columns = [
...
def keywords():
    ...
    return render_template("keywords.html", keywords=keywords_dict, top_tfidf_keywords=top_tfidf_keywords)
